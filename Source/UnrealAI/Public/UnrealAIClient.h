...
class FUnrealAIExecutionService;
...
class UNREALAI_API UUnrealAIClient : public UObject
{
  ...
  private:
	TSharedRef<FUnrealAIExecutionService, ESPMode::ThreadSafe> GetExecution() const;
	mutable TSharedPtr<FUnrealAIExecutionService, ESPMode::ThreadSafe> Execution;
};
