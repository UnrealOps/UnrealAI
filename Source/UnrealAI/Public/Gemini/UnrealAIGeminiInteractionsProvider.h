...
/** Exact first-party Gemini Interactions route and model allowlist. */
struct UNREALAI_API FUnrealAIGeminiInteractionsProviderConfig final
{
	...
	static FUnrealAIModelProfileProjection MakeInteractionsModelProfile(const FString &ModelId);
};

/** Native Gemini Interactions implementation of the provider-neutral model SPI. */
class UNREALAI_API FUnrealAIGeminiInteractionsProvider final : public IUnrealAIModelProvider
{
  public:
	FUnrealAIGeminiInteractionsProvider(
	...
	~FUnrealAIGeminiInteractionsProvider() override;
